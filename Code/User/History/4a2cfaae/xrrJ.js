...
const checkBalloonSize = () => {
    let ballonWidthInflated = balloonWidth * (scale + GROWING_FACTOR);
    if (ballonWidthInflated >= window.innerWidth) {
        console.log(ballonWidth, ballonWidthInflated, window.innerWidth);
        return false;
    }
    return true;
}
