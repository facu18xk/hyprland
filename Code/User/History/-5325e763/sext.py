...
options = Options()
webdriver = webdriver.Firefox(options=options, executable_path='/usr/bin/geckodriver')
...
hashtag_list =  ['LaptopEnVenta',
    ...
    'VentaTecnológica',
    'LaptopDeSegunda',
    'OfertasTecnológicasParaguay',
    'VenderElectrónicos',
    'OfertaLaptop',
    'IntercambioTecnológico',
    'CompraVentaParaguay',
    'TecnologíaUsada',
    'VentaLaptop',
    'ParaguayTecnológicoOfertas',
    'ElectrónicosEnVenta',
    'VenderLaptopUsada',
    'ParaguayCompraVenta',
    'GadgetEnVenta',
    ...
    'MercadoTecnológico',
    'LaptopVenta',
    'EscenaTecnológicaParaguay',
    'ElectrónicaVenta',
    'VenderLaptopUsada',
    'ParaguayVentas',
    'GadgetsEnVenta',
    'LaptopDeOcasión',
    'ClasificadosTecnológicos',
    'CompraVentaIntercambio',
    'ParaguayLaptop',
    'MercadoTecnológico',
    'LaptopVenta',
    'ClasificadosDeGadgets',
    'VenderElectrónicos',
    'ParaguayVendeTecnología',
    'TecnologíaDeSegunda',
    'LaptopEnVenta',
    'OfertasTecnológicas',
    'ElectrónicosUsados',
