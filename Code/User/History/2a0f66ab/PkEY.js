...
/**
 *  Change dom elements value with content specific to the race's distance selected 
 * @param {*} clickedElement Number of the element clicked
 */
const active = (clickedElement) => {
    if (clickedElement != activeDistance) {
        ...
        //Change the download plan file to its 
