...
function tie() {
    ...
    tieScene.play();
    tieScene.addEventListener("loadedmetadata", () => {
        setTimeout(() => {
            tieScene.pause();

        },
            Math.floor(tieScene.duration * MILLISECONDS))
    })
}
/**
...
function round(video) {
    video.addEventListener("loadedmetadata", () => {
        ...
        }, (Math.floor((video.duration - video.currentTime) * MILLISECONDS) - (MILLISECONDS * 3)));
    })
}
function firstRound() {
